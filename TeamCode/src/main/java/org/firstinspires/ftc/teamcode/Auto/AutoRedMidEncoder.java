 ...
 */
@Autonomous(name = "AutoRedMidEncoder", group = "Auto")
public class AutoRedMidEncoder extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException{
        ...
        robot.moveRobot(0.2,0,0);
        sleep(1000);
        robot.encoderMoveBackfoward(forwardDistance,3,0.3);
        robot.moveRobot(0,0,0);

        //Put block
        robot.encoderMoveTurn(800,3,-0.4);
        robot.moveRobot(0,0,0);
        sleep(1000);
